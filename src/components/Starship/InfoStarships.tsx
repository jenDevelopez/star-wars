...
export default function InfoStarship() {
  ...
  return (
    <div className=" my-3 flex flex-col justify-center items-center dark:bg-zinc-900">
      <div className="self-center my-5">
        <p className="text-xl dark:dark:text-gray-100 text-center">
      ...
      <div className="flex justify-around my-5 w-4/5">
        <div className="self-start w-1/2">
          <p className="text-lg dark:dark:text-gray-100">
